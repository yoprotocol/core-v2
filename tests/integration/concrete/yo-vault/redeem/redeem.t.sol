...
contract RedeemIntegrationConcreteTest is YoVaultBase_Test {
    ...
    function test_WhenInstantRedeem_Succeeds() external {
        ...
        vm.prank(users.alice);
        yoVault.redeem(aliceShares, users.alice, users.alice);
    ...
    function test_RevertWhen_SharesAmountZero() external {
        ...
        yoVault.redeem(0, users.alice, users.alice);
    }
    ...
    function test_RevertWhen_NotSharesOwner() external {
        ...
        yoVault.redeem(aliceShares, users.alice, users.bob);
    }
    ...
    function test_RevertWhen_InsufficientShares() external {
        ...
        yoVault.redeem(aliceShares + 1, users.alice, users.alice);
    }
}
